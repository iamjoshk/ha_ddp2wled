...
This repository contains a Home Assistant custom integration. These instructions are based on the latest Home Assistant core Copilot and Claude Code instructions.
